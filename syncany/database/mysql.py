...
class MysqlDB(DataBase):
    ...
    def query(self, name, *fields):
        return MysqlQueryBuilder(self, name, fields)

    def insert(self, name, datas):
        return MysqlInsertBuilder(self, name, datas)

    def update(self, name, **update):
        return MysqlUpdateBuilder(self, name, update)

    def delete(self, name):
        return MysqlDeleteBuilder(self, name)
